  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-3 sm:px-5 py-3 sm:py-4 border-b border-gray-800">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <span className="text-emerald-400 font-semibold text-xs sm:text-sm leading-none block">.ai</span>
              <div className="text-gray-500 text-[9px] sm:text-[10px] leading-none mt-0.5">Brasil</div>
            </div>
          </div>
          <button
            onClick={onClose}
            className="lg:hidden text-gray-500 hover:text-gray-300 transition-colors flex-shrink-0 p-1"
          >
            <X size={18} />
          </button>
        </div>
        ...
        {/* Badge de plano */}
        {isFree && (
          <div className="mx-2 sm:mx-4 mt-2 sm:mt-3 mb-1 px-2 sm:px-3 py-2 rounded-lg bg-amber-500/10 border border-amber-500/20 flex items-center gap-2">
            <Crown size={12} className="text-amber-400 flex-shrink-0" />
            <div className="min-w-0">
              <p className="text-amber-300 text-[10px] sm:text-[11px] font-medium leading-none">Plano Freemium</p>
              <p className="text-amber-500/70 text-[9px] sm:text-[10px] leading-none mt-0.5">7 dias de acesso</p>
            </div>
          </div>
        )}
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p
                    className={`text-[10px] sm:text-[11px] truncate mt-0.5 transition-colors ${
                ...
                {/* Active indicator */}
                {isActive && (
                  <div className="w-1 h-5 sm:h-6 rounded-full bg-emerald-400 flex-shrink-0" />
                )}
              </button>
            );
          })}
        ...
        {isFree && (
          <div className="mx-2 sm:mx-3 mb-3 sm:mb-4 p-2 sm:p-3 rounded-xl bg-gradient-to-br from-emerald-900/40 to-emerald-800/20 border border-emerald-700/30">
            ...
            <a
              ...
              className="block text-center text-[11px] sm:text-xs font-semibold py-1.5 px-3 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-gray-950 transition-colors"
            >
              Assinar agora
            </a>
          </div>
